...
pca_bspan  = pc$x %>% 
 ...
 # pivot_wider(names_from = "PC", names_prefix = "PC", values_from = "value") %>% 
  ...
  geom_point(aes(colour = Regions, shape = Period),size=5) + 
  theme_bw()+ theme(legend.position = "top") + 
...
pca_pe  = pc$x %>% 
 ...
 # pivot_wider(names_from = "PC", names_prefix = "PC", values_from = "value") %>% 
  ...
  geom_point(aes(colour = ContributingStudy, shape = Period),size=5, alpha = 0.75) + 
  theme_bw()+ theme(legend.position = "top") + 
   labs(
    x = glue("PC1 ({percent(pc$sdev[[1]]^2 / sum(pc$sdev^2), 0.1)})"),
    y = glue("PC2 ({percent(pc$sdev[[2]]^2 / sum(pc$sdev^2), 0.1)})")
...
pca_hdbr = pc$x %>% 
 ...
 # pivot_wider(names_from = "PC", names_prefix = "PC", values_from = "value") %>% 
  ggplot(aes(PC1, PC2)) +
  geom_point(aes(colour = IntronicRate, shape = Regions),size=5, alpha = 0.85) +
...
ggsave(gtex_fig, file=here::here("output/Thesis_plots/Variance/Examples/GTEx-region-RNASE2.svg"), 
        width = 8, 
       height =5, 
       units = "in")
...
bspan_fig
ggsave(bspan_fig, file=here::here("output/Thesis_plots/Variance/Examples/BrainSpan-region-RNASE2.svg"), 
        width = 8, 
       height =5, 
       units = "in")
...
e$Raw$HDBR %>% 
  ...
  drop_na(PMI.intervals) %>%
  ggplot(aes(x = PMI.intervals,  y = Exp)) + geom_boxplot() +
  theme_bw() 


HDBR_plot = e$Raw$HDBR %>% 
    as.data.frame() %>%
    rownames_to_column("EnsemblID") %>%
    left_join(gene2symbol, by = "EnsemblID") %>% 
    dplyr::filter(gene_name %in% "RNASE2") %>% 
...
HDBR_plot 
ggsave(HDBR_plot, file=here::here("output/Thesis_plots/Variance/Examples/HDBR-region-RNASE2.svg"), 
        width = 8, 
       height =5, 
       units = "in")
```
...
```{r}
gtex_var =var_part$GTEx %>% 
  dplyr::filter(gene_name %in% "RNASE2") %>% 
  melt() %>%
  arrange(value) %>%
  ggplot(aes(x= fct_reorder(variable, value), y = value)) + geom_bar(stat = "identity", fill = "#F04C51") +
  coord_flip() + theme_bw() + ylab("Variance Explained (%)") + xlab("") 
gtex_var

ggsave(gtex_var, file=here::here("output/Thesis_plots/Variance/Examples/GTEx-varPart-RNASE2.svg"), 
        width = 5, 
       height =6, 
       units = "in")
```
...
gtex_plot
ggsave(gtex_plot, file=here::here("output/Thesis_plots/Variance/Examples/GTEx-region-CXCL2.svg"), 
        width = 8, 
       height =5, 
       units = "in")
...
ggsave(bspan_fig, file=here::here("output/Thesis_plots/Variance/Examples/BrainSpan-region-CXCL2.svg"), 
        width = 8, 
       height =5, 
       units = "in")
```
...
HDBR_plot =e$Raw$HDBR %>% 
  ...
  drop_na(PMI.intervals) %>%
  ggplot(aes(x = PMI.intervals,  y = Exp, fill = Regions)) + geom_boxplot() +
  theme_bw() + scale_fill_manual(values = c("Cortex" = "#E85571", 
                                 "Subcortex" = "#838DE0", 
                                 "Cerebellum" = "#FFD256",
                                 "Spinal Cord" = "#C6D14A", 
...
HDBR_plot
ggsave(HDBR_plot, file=here::here("output/Thesis_plots/Variance/Examples/HDBR-region-CXCL2.svg"), 
        width = 8, 
       height =5, 
       units = "in")
```
...
ggsave(gtex_var, file=here::here("output/Thesis_plots/Variance/Examples/GTEx-varPart-CXL2.svg"), 
        width = 5, 
       height =6, 
       units = "in")
```
...
ggsave(hdbr_var, file=here::here("output/Thesis_plots/Variance/Examples/HDBR-varPart-CXL2.svg"), 
        width = 5, 
       height =6, 
       units = "in")
```
...
ggsave(bspan_var, file=here::here("output/Thesis_plots/Variance/Examples/BrainSpan-varPart-CXL2.svg"), 
        width = 5, 
       height =6, 
       units = "in")
```
...
ggsave(gtex_plot, file=here::here("output/Thesis_plots/Variance/Examples/GTEx-region-EGR3.svg"), 
        width = 8, 
       height =5, 
       units = "in")
```
...
bspan_plot 
ggsave(bspan_plot, file=here::here("output/Thesis_plots/Variance/Examples/BrainSpan-region-EGR3.svg"), 
        width = 8, 
       height =5, 
       units = "in")
...
hdbr_plot = e$Raw$HDBR %>% 
  ...
  theme(legend.position = "top", 
        ...
        panel.grid.major.y = element_line( size=.1 ) )
hdbr_plot
ggsave(hdbr_plot , file=here::here("output/Thesis_plots/Variance/Examples/HDBR-region-EGR3.svg"), 
        width = 8, 
       height =5, 
       units = "in")
```
...
ggsave(gtex_var, file=here::here("output/Thesis_plots/Variance/Examples/GTEx-varPart-EGR3.svg"), 
        width = 5, 
       height =6, 
       units = "in")
```
...
ggsave(hdbr_var, file=here::here("output/Thesis_plots/Variance/Examples/HDBR-varPart-EGR3.svg"), 
        width = 5, 
       height =6, 
       units = "in")
```
...
ggsave(bspan_var, file=here::here("output/Thesis_plots/Variance/Examples/BrainSpan-varPart-EGR3.svg"), 
        width = 5, 
       height =6, 
       units = "in")
```
...
ggsave(gtex_plot , file=here::here("output/Thesis_plots/Variance/Examples/GTEx-region-HBA1.svg"), 
        width = 8, 
       height =5, 
       units = "in")
```
...
bspan_plot
ggsave(bspan_plot , file=here::here("output/Thesis_plots/Variance/Examples/BrainSpan-region-HBA1.svg"), 
        width = 8, 
       height =5, 
       units = "in")
```
...
ggsave(gtex_var, file=here::here("output/Thesis_plots/Variance/Examples/GTEx-varPart-HBA1.svg"), 
        width = 5, 
       height =6, 
       units = "in")
```
...
ggsave(hdbr_var, file=here::here("output/Thesis_plots/Variance/Examples/HDBR-varPart-HBA1.svg"), 
        width = 5, 
       height =6, 
       units = "in")
```
...
ggsave(bspan_var, file=here::here("output/Thesis_plots/Variance/Examples/BrainSpan-varPart-HBA1.svg"), 
        width = 5, 
       height =6, 
       units = "in")
```

## Time-course with PMI?
