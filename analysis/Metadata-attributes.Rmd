...
x= list( "BrainSeq" = seq.metrics$BrainSeq$BITColumnName, 
...
UpSetR::upset(fromList(x), sets.bar.color = c("#7DA1D4","#E11F28","#F1605F","#49215F"),
...
```{r}
x= list( "BrainSeq" = pheno.metrics$BrainSeq$BITColumnName, 
...
UpSetR::upset(fromList(x), sets.bar.color = c("#FAAD79","#F1605F","#E11F28","#7DA1D4","#49215F"),
              main.bar.color = c("#FAAD79","#7DA1D4","#E11F28","#F1605F",
                                "#808080","#808080","#808080"), 
              mainbar.y.label = "Overlap of Phenotype Data",
              sets.x.label = "Total Phenotype Data",
                text.scale = c(1.2, 2, 1.2), 
              point.size = 4)
...
```{r}
x= list( "BrainSeq" = sample.metrics$BrainSeq$BITColumnName, 
...
UpSetR::upset(fromList(x), sets.bar.color = c("#FAAD79","#7DA1D4","#F1605F","#E11F28","#49215F"),
              main.bar.color = c("#FAAD79","#7DA1D4","#E11F28","#F1605F",
                                "#808080","#808080","#808080", "#808080"), 
