...
md$BrainSeq = read.csv(file.path(dir,"Brainseq/Formatted/BrainSeq-metadata.csv"), header=TRUE, check.names = FALSE)
md$BrainSpan = read.csv(file.path(dir,"BrainSpan/Formatted/BrainSpan-metadata.csv"), header=TRUE, check.names = FALSE)
md$GTEx =  read.csv(file.path(dir,"GTEx/Formatted/GTEx-metadata.csv"), header=TRUE, check.names = FALSE)
md$HDBR = read.csv(file.path(dir, "HDBR/Formatted/HDBR-metadata.csv"), header=TRUE, check.names = FALSE)
...
pdf("../../Results/Thesis_plots/HDBR-corplot.pdf", height = 30, width=30)
corrplot(M, order='hclust',
         method = "circle", 
         number.cex = .50, type="upper", 
         cl.cex = 3,
         tl.cex=1.2)
dev.off()
```
