...
```{r}
pdf(file = "/home/neuro/Documents/Brain_integrative_transcriptome/BITHub-preprocessing/output/Thesis_plots/Examples/NDDs/CT-exp-FMR1.pdf", height = 6, width =8)
ggarrange(cam_fmr1, hca_fmr1)
dev.off
```
