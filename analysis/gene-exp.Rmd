...
```{r}
pdf(file = here::here("output/Thesis_plots/Examples/ZIC2-zscore.pdf"),
       height = 6, width = 18)
...
```{r}
pdf(file = here::here("output/Thesis_plots/Examples/MKI67-all.pdf"),
       height = 14, width = 16)
ggarrange(bseq, bspan,
          gtex, hdbr, pe, ncol=2, nrow=3 )
...
```{r}
pdf(file = here::here("output/Thesis_plots/Examples/MKI67-zscore.pdf"),
       height = 6, width = 18)
...
cor_RNASE2_gtex = e$Raw$GTEx %>% 
  ...
  ylab("TPM") +  theme(axis.text.x = element_text(size = 12, family = "serif", color = "black", angle = 90),
        axis.text.y = element_text(size = 15, family = "serif", color = "black"), 
        axis.title = element_text(size=15, family = "serif"), 
         legend.box.background = element_rect(color = "black"),
          legend.text = element_text(family = "serif"), 
...
cor_RNASE2_bspan = e$Raw$BSpan %>% 
  ...
  ylab("RPKM") +  theme(axis.text.x = element_text(size = 12, family = "serif", color = "black", angle = 90),
        axis.text.y = element_text(size = 15, family = "serif", color = "black"), 
        axis.title = element_text(size=15, family = "serif"), 
         legend.box.background = element_rect(color = "black"),
          legend.text = element_text(family = "serif"), 
...
ggarrange(cor_RNASE2_bspan, cor_RNASE2_gtex, 
          ...
          cor_EGR3_bspan, cor_EGR3_bspan, ncol =2, nrow=4)
...
```{r}
genes_of_interest = c("FMR1", "ZMYND8", "UPF1", "SPAST", "ATL1", "CTNNB1", "KCNQ2")
exp_data = list()
datasets = c("BSpan", "GTEx", "BSeq", "PE", "HDBR")
for (x in datasets) {
  message(paste("Subsetting samples for", x))
...
```{r}
ggsave(filename = here::here("output/Thesis_plots/Examples/NDDs/SPAST-all.svg"),
       height = 14, width = 16, units = "in")
ggarrange(bseq, bspan,
          gtex, hdbr, pe, ncol=2, nrow=3 )
...
```{r}
ggsave(filename = here::here("output/Thesis_plots/Examples/NDDs/CTNNB1-all.svg"),
       height = 14, width = 16, units = "in")
ggarrange(bseq, bspan,
          gtex, hdbr, pe, ncol=2, nrow=3 )
...
```{r}
ggsave(filename = here::here("output/Thesis_plots/Examples/NDDs/ATL1-all.svg"),
       height = 14, width = 16, units = "in")
ggarrange(bseq, bspan,
          gtex, hdbr, pe, ncol=2, nrow=3 )
...
exp_data %>% 
  do.call(rbind, .) %>% 
  dplyr::filter((gene_name == "KCNQ2" & Dataset == "BSeq")) %>%
    mutate(AgeInterval = factor(AgeInterval, 
                              levels = c("4-7pcw", "8-9pcw",
                                         "10-12pcw", "13-15pcw", "16-18pcw",
                                         "19-24pcw", "25-38pcw", "0-5mos",
...
exp_data %>% 
  do.call(rbind, .) %>% 
  dplyr::filter((gene_name == "KCNQ2" & Dataset == "BSpan")) %>%
    mutate(AgeInterval = factor(AgeInterval, 
                              levels = c("4-7pcw", "8-9pcw",
                                         "10-12pcw", "13-15pcw", "16-18pcw",
                                         "19-24pcw", "25-38pcw", "0-5mos",
...
exp_data %>% 
  do.call(rbind, .) %>% 
  dplyr::filter((gene_name == "KCNQ2" & Dataset == "GTEx")) %>%
    mutate(AgeInterval = factor(AgeInterval, 
                              levels = c("4-7pcw", "8-9pcw",
                                         "10-12pcw", "13-15pcw", "16-18pcw",
                                         "19-24pcw", "25-38pcw", "0-5mos",
...
exp_data %>% 
  do.call(rbind, .) %>% 
  dplyr::filter((gene_name == "KCNQ2" & Dataset == "HDBR")) %>%
    mutate(AgeInterval = factor(AgeInterval, 
                              levels = c("4-7pcw", "8-9pcw",
                                         "10-12pcw", "13-15pcw", "16-18pcw",
                                         "19-24pcw", "25-38pcw", "0-5mos",
...
exp_data %>% 
  do.call(rbind, .) %>% 
  dplyr::filter((gene_name == "KCNQ2" & Dataset == "PE")) %>%
    mutate(AgeInterval = factor(AgeInterval, 
                              levels = c("4-7pcw", "8-9pcw",
                                         "10-12pcw", "13-15pcw", "16-18pcw",
                                         "19-24pcw", "25-38pcw", "0-5mos",
